...
@EnableJpaRepositories(entityManagerFactoryRef = "entityManagerFactory",
		...
		basePackages = {"vn.yotel.admin", "vn.vano" })
...
public class JpaPersistenceConfig {
    ...
    private static final String PROPERTY_NAME_ENTITYMANAGER_PACKAGES_TO_SCAN_HR = "vn.vano.cms.jpa";
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		emf.setPackagesToScan(new String[] { PROPERTY_NAME_ENTITYMANAGER_PACKAGES_TO_SCAN,
				PROPERTY_NAME_ENTITYMANAGER_PACKAGES_TO_SCAN_HR});
